...
# tunables
dataset = 'mimic'  # nih #chexbert
resnetmodel = ResNet152V2
pre_weights = None
metrics = ['accuracy']  # ['AUC'] #F1Score
learning_rate = 0.05  # orig 0.001
output_class = 14
epochs = 10
batch_size = 32
...
# preprocess
df = pd.read_csv(os.path.join(nih14_folder, 'labels',
                 'NIH_Original label_pp_use this.csv'))
# labels = df.iloc[:, -14:]
